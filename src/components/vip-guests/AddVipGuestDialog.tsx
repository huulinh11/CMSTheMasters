...
import { VipGuestFormValues, vipGuestFormSchema, ROLES } from "@/types/vip-guest";
...
interface AddVipGuestDialogProps {
  ...
  defaultValues?: VipGuestFormValues | null;
}
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>{defaultValues ? "Chỉnh sửa khách" : "Thêm khách mới"}</DialogTitle>
          <DialogDescription>
            {defaultValues ? "Cập nhật thông tin chi tiết." : "Điền thông tin để thêm khách chức vụ mới."}
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
